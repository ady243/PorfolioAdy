    ...
    <>
      <ThemeProvider attribute="class">
        <div className="grid grid-cols-12 gap-6 my-14 lg:px-48 sm:px- md:px-">
          ...
          <div className="flex flex-col col-span-12 bg-gray-100 lg:col-span-9 rounded-2xl overflox-2xl dark:bg-dark-500 shadow-custom-light dark:shadow-custom-dark">
            <Navbar />
            <Component {...pageProps} />
          </div>
        </div>
